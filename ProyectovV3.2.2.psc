...
Funcion sumar_matrices
	...
	Escribir ""
	Escribir "Ingrese el nº de filas y columnas de la matriz A (NxM):"
	Escribir " [N]: "
	ComprobacionDimension(Na)
	Escribir ""
	Escribir " [M]: "
	ComprobacionDimension(Ma)
	Escribir ""
	Escribir "Ingrese el nº de filas y columnas de la matriz B (NxM):"
	Escribir " [N]: "
	ComprobacionDimension(Nb)
	Escribir ""
	Escribir " [M]: "
	ComprobacionDimension(Mb)
	Escribir ""
	...
	Si val_suma(Na, Ma, Nb, Mb) = 1 Entonces  // Llamada a la función validar para validar que se puedan sumar.
		Escribir "Las matrices A y B no se pueden sumar. Deben ser del mismo orden"
		Escribir ""
...
//Funcion que comprueba que ninguna dimension de las matrices sea 0 o menor.
Funcion ComprobacionDimension(num por referencia)
	Repetir 
		Leer num
		Si num <= 0 Entonces
